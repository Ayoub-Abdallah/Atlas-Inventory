  ...
  <div class="space-y-6 max-w-5xl mx-auto">
    ...
    <div class="grid gap-6 lg:grid-cols-12">
      <div v-if="settings" class="lg:col-span-8 space-y-6">
        ...
        <div :class="ui.card">
          <div :class="ui.cardHeader">
            <h2 :class="ui.cardTitle">{{ t('settings.storefront.title') }}</h2>
            <Icon name="lucide:store" class="h-4 w-4 text-gray-400" />
          </div>
          <div :class="ui.cardBody">
            <div class="grid gap-5 sm:grid-cols-2">
              <div class="sm:col-span-2">
                <label :class="ui.label">{{ t('settings.storefront.siteUrl') }}</label>
                <input
                  ...
                  dir="ltr"
                />
                <p class="mt-1 text-xs text-gray-400">{{ t('settings.storefront.siteUrlHelp') }}</p>
              </div>

              <div>
                <label :class="ui.label">{{ t('settings.storefront.countryCode') }}</label>
                <input
                  v-model="settings.phoneCountryCode"
                  type="text"
                  :class="[ui.input, 'font-mono']"
                  placeholder="+213"
                  dir="ltr"
                />
                <p class="mt-1 text-xs text-gray-400">{{ t('settings.storefront.countryCodeHelp') }}</p>
              </div>

              <div>
                <label :class="ui.label">{{ t('settings.storefront.storePhone') }}</label>
                <input
                  ...
                  dir="ltr"
                />
                <p class="mt-1 text-xs text-gray-400">{{ t('settings.storefront.storePhoneHelp') }}</p>
              </div>

              <div class="sm:col-span-2">
                <label :class="ui.label">{{ t('settings.storefront.storeAddress') }}</label>
                <input
                  v-model="settings.storeAddress"
                  type="text"
                  :class="ui.input"
                  :placeholder="t('settings.storefront.storeAddressPlaceholder')"
                />
              </div>
            </div>
          </div>
