  ...
  <div class="space-y-6 print:space-y-4">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6">
      ...
      <div class="mt-4 pt-4 border-t border-gray-100 flex justify-end">
        <NuxtLink to="/admin/credit" class="text-sm text-blue-600 hover:text-blue-700 flex items-center gap-1">
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-100">
            <tr
              ...
              @click="navigateTo(sale.sourceType === 'reparation' ? `/admin/reparations/${sale.id}` : `/admin/sales/${sale.id}`)"
            >
              <td class="py-3">
                <span
