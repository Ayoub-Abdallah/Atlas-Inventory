...
<template>
  <div class="space-y-6">
    ...
    <div v-else-if="error" class="bg-red-50 rounded-xl p-8 text-center">
      ...
      <UiButton variant="outline" @click="navigateTo('/admin/reparations')">
    ...
    <div v-else-if="reparation" class="print:bg-white">
      ...
      <div class="flex items-center justify-between print:hidden">
        <div class="flex items-center gap-4">
          <UiButton variant="ghost" size="sm" @click="navigateTo('/admin/reparations')">
        ...
        <div class="flex items-center gap-3">
          <UiButton v-if="isEditable" variant="outline" @click="navigateTo(`/admin/reparations/${repId}/edit`)">
      ...
      <div v-if="reparation.status === 'draft'" class="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-center justify-between print:hidden">
        ...
        <UiButton @click="navigateTo(`/admin/reparations/${repId}/edit`)">
          <Icon name="lucide:pencil" class="h-4 w-4 mr-2" />
